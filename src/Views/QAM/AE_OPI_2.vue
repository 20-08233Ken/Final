    ...
    <div class="w-full flex shadow-card2 py-5 px-8 gap-4 bg-gray-700 mt-8">
        ...
        <span class="flex flex-col justify-center w-9/12">
            ...
            <p class="w-full text-sm text-gray-400">
                Advanced Education Program: Output Indicator 2
            </p>
                ...
                <table class="w-full mt-4">
                    <thead>
                        <tr class="bg-gray-700">
                            ...
                            <th
                                class="border-2 py-3 text-white font-Subheader text-center text-0.9 text-Subheader text-gray-700">
                                Required Files</th>
                            <th
                                class="border-2 py-3 text-white font-Subheader text-center text-0.9 text-Subheader text-gray-700">
                                Upload Files</th>
                    ...
                    <tbody>
                        <tr>
                            <td class="w-2/12 py-3 border-2 text-0.9 text-Subheader text-gray-700 ">1</td>
                            <td class="w-7/12 py-3 px-3 border-2 text-0.9 text-Subheader text-gray-700">
                                Supporting documentation</td>
                            <td class="w-3/12 py-3 border-2 text-0.9 text-Subheader text-gray-700 ">
...
<style scoped>
    ...
    @import url('../../style/QAM/AE_OPI_2.css');
